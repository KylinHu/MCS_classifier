...
outpath = '../Data/raw_3hr/'  # path where regime files are output to
fv = 255.    # fill value
...
filename = 'hist_%4d%02d.asc' % (year, month)
np.savetxt(outpath + filename, hist_tt)
